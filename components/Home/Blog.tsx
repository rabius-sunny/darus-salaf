...
export default function Blog() {
    return (
        <>
            {/* <div className="min-h-screen bg-indigo-600 flex justify-center items-center py-20"> */}
                <div className="container mx-auto px-12 py-20 bg-indigo-100 rounded-xl">
                    <h1 className="text-4xl text-center text-indigo-600 uppercase font-bold from-current mb-8">Read from blog</h1>
